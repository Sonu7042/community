function AdCard({ ad, index }) {
  return (
    <article
      className="ad-fade-loop overflow-hidden rounded-2xl border border-stroke bg-panel shadow-panel"
      style={{ animationDelay: `${index * 1.4}s` }}
    >
      <div className="relative">
        <img src={ad.image} alt={ad.title} className="h-52 w-full object-cover" />
