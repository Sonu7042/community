...
export function FireIcon({ className = 'h-4 w-4' }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className={className}>
      <path d="M12 3c1.5 3-1 4.5-1 6.5S13 12 13 14a3 3 0 0 1-6 0c0-2 1-3.5 2.2-4.8C10.3 8 11 6.5 12 3Z" />
      <path d="M14.5 10c3.1 2.5 4.5 4.6 4.5 7a7 7 0 1 1-14 0c0-1.4.4-2.7 1.3-4" />
    </svg>
  );
}
...
export function UpIcon({ className = 'h-3.5 w-3.5' }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className={className}>
...
export function CommentIcon({ className = 'h-4 w-4' }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className={className}>
      <path d="M20 11.5c0 4.1-3.8 7.5-8.5 7.5-1.3 0-2.6-.3-3.7-.8L4 19l1.2-3C4.4 14.8 3 13.2 3 11.5 3 7.4 6.8 4 11.5 4S20 7.4 20 11.5Z" />
    </svg>
  );
}
